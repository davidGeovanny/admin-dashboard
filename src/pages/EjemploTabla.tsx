...
export const EjemploTabla = () => {
  ...
  const onClickHandler = ( e: React.MouseEvent<HTMLTableRowElement> ) => {
    // const hiddenElement = e.currentTarget.nextElementSibling?.firstChild?.firstChild as HTMLElement;
    // if( hiddenElement ) {
    //   hiddenElement.className.indexOf('collapse show fadeIn') > -1 ? hiddenElement.classList.remove('show', 'fadeIn') :  hiddenElement.classList.add('show', 'fadeIn');
    // }
  }
